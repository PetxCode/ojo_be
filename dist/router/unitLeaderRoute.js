...
router.route("/verify-unit-leader/").post(unitLeaderController_1.verifyUnitLeader);
...
router.route("/view-unit-member/:unitID").get(unitLeaderController_1.viewUnitLeaderMembers);
router
...
router.route("/update-unit-info/:id").patch(unitLeaderController_1.updateUnitProfile);
router.route("/update-unit-avatar/:id").patch(multer_1.fileUpload, unitLeaderController_1.updateUnitAvatar);
